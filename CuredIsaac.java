 ...
 */
public class CuredIsaac extends Actor
{
    int hp=3;
    int bomb=0;
...
public CuredIsaac()
{
    ...
    imageLeft= new GreenfootImage("Curedisaacleft.png");
    imageRight= new GreenfootImage("Curedisaacright.png");
    imageDown= new GreenfootImage("Curedisaac.png");
}
...
public void changeworld() {
    ...
    protected boolean foundRock() {
         ...
         bomb++;
         CuredBullet bullet = new CuredBullet();
